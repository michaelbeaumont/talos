...
func (o *RawVolumeConfigV1Alpha1) DeepCopy() *RawVolumeConfigV1Alpha1 {
	...
	if o.EncryptionSpec.EncryptionKeys != nil {
		...
		for i3 := range o.EncryptionSpec.EncryptionKeys {
			...
			if o.EncryptionSpec.EncryptionKeys[i3].KeyUnmanaged != nil {
				cp.EncryptionSpec.EncryptionKeys[i3].KeyUnmanaged = new(EncryptionKeyUnmanaged)
				*cp.EncryptionSpec.EncryptionKeys[i3].KeyUnmanaged = *o.EncryptionSpec.EncryptionKeys[i3].KeyUnmanaged
			}
